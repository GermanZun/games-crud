    ...
    <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900">{{__('Información de los juegos')}}</h3>
                <p class="mt-1 text-sm text-gray-600">{{__('Ingrese un nuevo juego o seleccione uno del listado para editarlo.')}}</p>
            </div>
        </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-6">
                                <label for="for_name" class="block text-sm font-medium text-gray-700">{{__('Nombre')}}</label>
                            ...
                            <div class="col-span-6 sm:col-span-6">
                                <label for="for_description" class="block text-sm font-medium text-gray-700">{{__('Descripción')}}</label>
                            ...
                            <div class="col-span-6 sm:col-span-6 ">
                                <label for="for_image_url" class="block text-sm font-medium text-gray-700">{{__('Url Imagen')}}</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="for_status" class="block text-sm font-medium text-gray-700">{{__('Estado')}}</label>
